...
public class AddJsonCreatorToPrivateConstructors extends Recipe {
    ...
    private static final String JACKSON_JSON_CREATOR = "com.fasterxml.jackson.annotation.JsonCreator";
    ...
    @Getter
    final String description = "Jackson 3 strictly enforces creator visibility rules. Non-public constructors with " +
            "`@JsonProperty` parameters that were auto-detected in Jackson 2 need an explicit `@JsonCreator` " +
        ...
        return Preconditions.check(
                ...
                new JavaIsoVisitor<ExecutionContext>() {
                    ...
                    public J.MethodDeclaration visitMethodDeclaration(J.MethodDeclaration method, ExecutionContext ctx) {
                        ...
                        // At least one parameter must have @JsonProperty
